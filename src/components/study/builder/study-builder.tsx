...
export function StudyBuilder({
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6 items-start lg:items-stretch lg:h-full lg:min-h-0">
      ...
      <div className="rounded-2xl border border-outline-variant bg-surface px-6 pt-6 pb-8 lg:pb-0 min-h-[300px] lg:min-h-0 lg:h-full lg:overflow-y-auto lg:overflow-x-hidden no-scrollbar">
        {sel === "welcome" ? (
          <WelcomeEditor
            studyId={studyId}
            editable={editable}
